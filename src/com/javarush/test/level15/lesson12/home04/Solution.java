...
public class Solution {
    ...
    public static void readKeyFromConsoleAndInitPlanet() throws Exception
    {
        ...
        if(in.equals(Planet.EARTH))thePlanet = Earth.getInstance();
        else if(in.equals(Planet.MOON))thePlanet = Moon.getInstance();
        else if(in.equals(Planet.SUN))thePlanet = Sun.getInstance();
        else thePlanet = null;
    }
}
