...
public class Solution {
    ...
    public static void reset()throws Exception {
        ...
        if(paramString.equals("helicopter"))result = new Helicopter();
        if(paramString.equals("plane")){
            int paramInt = Integer.parseInt(reader.readLine());
            result = new Plane(paramInt);
        }
        reader.close();
    }
}
